...
class EditContactPage extends StatefulWidget {
  ...
  const EditContactPage({super.key, required this.contactToEdit});
...
class _EditContactPageState extends State<EditContactPage> {
  ...
  void initState() {
    super.initState();
    _mainNameController = TextEditingController(
      text: widget.contactToEdit.mainName,
    );
    _emailController = TextEditingController(text: widget.contactToEdit.email);
    _otherNamesController = TextEditingController(
      text: widget.contactToEdit.otherNames.join(', '),
    );
  }
